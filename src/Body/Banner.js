...
//  className: "banner",
  ...
  // prevArrow : <ArrowBackIosIcon />,
  //   nextArrow : <ArrowForwardIosIcon />
  // autoplay={true} autoplaySpeed={5000} duration={500} className="banner" prevArrow={<ArrowBackIosIcon />} nextArrow={<ArrowForwardIosIcon />
  return (
    <>
  <Slider  { ...sliderConfigure }>
